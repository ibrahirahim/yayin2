...
M3U_URL = "https://raw.githubusercontent.com/ibrahirahim/yayin3/refs/heads/main/akasya_duragi_tum_bolumler.m3u"
LOGO_URL = "https://raw.githubusercontent.com/ibrahirahim/yayin3/refs/heads/main/file_0000000052cc820ab42dc2720be0c383.png"
...
def start_m3u_stream():
    ...
    while True:
        ...
        print("=" * 60)
        print("📺 SSH101 Canlı M3U Aktarım Yayını (1080p / 2800k) Başlatılıyor")
        ...
        # 1080p (1920x1080) Ölçeklendirme ve Logo Filtresi
        if has_logo:
            filter_str = (
        ...
        # 1080p Akıcı Yayın Ayarları (2800k Bitrate)
        command = [
            'ffmpeg',
            '-headers', headers_arg,
            '-ss', str(last_seconds),
            ...
            '-map', '0:a?',
            '-c:v', 'libx264',
            '-preset', 'veryfast',   # Düşük CPU kullanımı
            '-pix_fmt', 'yuv420p',
            '-b:v', '2800k',        # Akıcı ve donmasız 2800k bitrate
            '-maxrate', '3000k',    # Sıçramaları sınırlar
            '-bufsize', '6000k',    # Tampon bellek
            '-g', '50',
            '-c:a', 'aac',
            '-b:a', '128k',
            '-ar', '44100',
        ...
        print("▶ FFmpeg başlatıldı, 1080p (2800k) canlı yayın iletiliyor...")
