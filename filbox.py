...
def start_stream():
    ...
    while True:
        try:
            ...
            # Sağ üst köşe pay ayarı (overlay=W-w-20:20) yapıldı
            if os.path.exists('logo.png'):
                logo_input = ['-i', 'logo.png']
                filter_str = '[0:v]scale=1280:720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:black[v0];[1:v]scale=-1:90[logo];[v0][logo]overlay=W-w-10:10[v]'
            else:
                logo_input = []
